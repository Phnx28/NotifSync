...
class ArchiveTabFragment : Fragment() {
        ...
        adapter = NotificationAdapter(
            ...
            onRestore = { notification ->
                lifecycleScope.launch {
                    ServiceLocator.notificationRepository.restore(notification.id)
                }
            }
        )
    ...
    private fun observeNotifications() {
        viewLifecycleOwner.lifecycleScope.launch {
            ServiceLocator.notificationRepository.getArchivedNotifications().collectLatest { notifications ->
